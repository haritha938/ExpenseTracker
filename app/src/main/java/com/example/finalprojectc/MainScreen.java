...
import com.example.finalprojectc.ui.logout.LogoutFragment;
import com.example.finalprojectc.ui.reports.ReportsFragment;
...
public class MainScreen extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_reports,R.id.nav_categories, R.id.nav_logout,R.id.nav_Editgoals,R.id.nav_aboutUs,R.id.nav_help,R.id.nav_profile)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //To display username and email in navigation drawer
